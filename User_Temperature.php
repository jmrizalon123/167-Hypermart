                      ...
                      <div class="row text-center">
                        <div class="col-sm-12">
                          <h2 class="animated fadeIn" style="color: rgb(8, 60, 95);">Thank You!</h2>
                            ...
                            <hr>
                                <div class="text-right modal-footer" style="margin-bottom: -30px; display: none;">
                                        ...
                                        <?php
                                            ...
                                            $result = mysqli_query($con,$sel_query);
                                                while($row = mysqli_fetch_assoc($result)) { ?>
                                                 <input type="text" class="form-control" name="Temperature" id="Temperature" placeholder="Temperature" value="<?php echo $row['temperature']; ?>"><br>
                                        <?php $count++; } ?>
                                </div>
                        </div>
