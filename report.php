                        ...
                        <div class="container-fluid animated bounceInUp" id="socia_media" style="display: none;">
                            ...
                            <p class="text-muted" style="font-size:80%;">NOTE: you can change your linked accounts anytime you want it.</p>
                                ...
                                <input type="text" class="form-control" name="instagram_account" placeholder="https://www.instagram.com/your username" value="<?php echo $row['instagram_account'] ?>">
                                    <small>NOTE: Just make sure you have entered a correct address, any misspelled characters will lead to incorrect IP address!</small>
                                <br>
                                <div class="text-left">
        ...
        <form action="index" method = "POST">
            <div class="modal-body text-center">
                ...
                <div class="custom-control custom-checkbox" style="margin-left: 25px; text-align: left; line-height: 20px;">
                    ...
                    <label class="custom-control-label" for="defaultIndet erminate1" style="font-size: 14px; color: black">1. Shortness of breath or difficulty breathing.</label>
                </div>
        ...
        <div class="limiter animated fadeIn">
                            ...
                            <li class="nav-item">
                                ...
                                <li class="nav-item avatar" style = "color: black;">
                                    ...
                                    <?php
                                        ...
                                        ?>
                                    <?php foreach ($users as $user):?>
                                        <img  src="<?php echo 'profiles/' . $user['profile_image'] ?>" class="avatar rounded-circle card-img-35 z-depth-1 d-flex ml-3" id="userProfile"
                  ...
                  <section class="text-center px-md-5 mx-md-5 dark-grey-text">
                    ...
                    <div class="row mb-5">
                      <div class="col-md-4 mx-auto">
                        ...
                        <i class="fas fa-exclamation-triangle fa-6x animated headShake infinite" style="color: red"></i>
                        </div>
                      </div>
                    </div>

                    <h3 class="font-weight-bold mb-4 pb-2">ERROR ATTEMPT HACK</h3>
                      ...
                      <div class="card card-list">
                        <div class="card-header white d-flex justify-content-between align-items-center py-3">
                          ...
                          <i class="fas fa-cogs fa-2x"></i>
                            <div class="d-flex flex-column pl-3">
                              <a href="#!" class="font-weight-normal mb-0">Report Log</a>
                            </div>
                          </div>
                        ...
                        <div class="py-4 grey lighten-4">
                          ...
                          <?php
                              ...
                              $email="";
                              $email = $_SESSION['email'];
                              $sel_query="SELECT * FROM report_log ORDER BY id desc;";
                              $result = mysqli_query($con,$sel_query);
                              while($row = mysqli_fetch_assoc($result)) { ?>

                            <img src="images\userimage.png" class="z-depth-1 rounded-circle float-left" width="40" alt="avatar image">
                            <div class="d-flex flex-column pl-3">
                              <div class="">
                                <a href="#!" class="font-weight-normal mb-0"><?php echo $row["email"]?></a>
                                <p class="small text-muted float-right mb-0"><?php echo $row['created_at'] ?></p>
                              </div>
                              <th><?php echo $row['subject']; ?><th>
                              <td><p class="font-weight-light dark-grey-text mb-0"><?php echo $row['message'] ?></p></td>
                            </div>
                                <hr>
                            <?php $count++; } ?>
                        ...
                        <div class="card-footer white py-3">
                          <div class="form-group mb-0">
                            <form action="" method="POST">
                              <textarea class="form-control rounded-0" name="msg" id="exampleFormControlTextarea1" rows="2" placeholder="Write a comment"></textarea>
                                  <p id="SPmsg"></p>
                                <div class="text-right pt-1">
                                  <button class="btn btn-primary btn-sm mb-0 mr-0" type="submit" id="submit">Submit</button>
                                </div>
                            </form>
                          </div>
                        </div>
            ...
            <script>
                ...
                document.getElementById("submit").onclick = function () {
                  if (msg.value == ""){
                    document.getElementById("SPmsg").innerHTML ="field is required *";
                    document.getElementById("SPmsg").style.display = "block";
                    document.getElementById("SPmsg").style.color = "red";
                    return false;
                  }
                  return true;
                }
